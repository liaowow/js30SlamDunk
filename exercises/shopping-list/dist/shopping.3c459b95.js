...
var list = document.querySelector('.list'); // create an array to hold our state

var items = [];

function handleSubmit(e) {
  e.preventDefault();
  var name = e.currentTarget.item.value; // if name is empty, don't submit it
  ...
  e.target.reset(); // fire off a custom event that tells anyone who cares that the items have been updated
...
function markAsComplete(id) {
  var markedItem = items.find(function (item) {
    return item.id === id;
  });
...
list.addEventListener('itemsUpdated', mirrorToLocalStorage); // Event delegation: listen for the click on the list (<ul></ul>)
...
},{}]},{},["../../../../../.nvm/versions/node/v13.8.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shopping.js"], null)
