...
async function fetchJoke(loader, jokeHolder, jokeBtn) {
  ...
  const data = await response.json(); // turn loader off, reveal text and btn
...
exports.loader = exports.jokeHolder = exports.jokeBtnSpan = exports.jokeBtn = void 0;
const jokeBtn = document.querySelector('.getJoke');
exports.jokeBtn = jokeBtn;
const jokeBtnSpan = jokeBtn.querySelector('.jokeText');
exports.jokeBtnSpan = jokeBtnSpan;
...
async function handleClick() {
  const {
    joke
  } = await (0, _index.fetchJoke)(_elements.loader, _elements.jokeHolder, _elements.jokeBtn);
  _elements.jokeHolder.textContent = joke;
  _elements.jokeBtnSpan.textContent = (0, _utils.randomItemFromArray)(_buttonText.default, _elements.jokeBtnSpan.textContent);
}
},{"./index.js":"lib/index.js","./elements.js":"lib/elements.js","./utils.js":"lib/utils.js","../data/buttonText.js":"data/buttonText.js"}],"jokes.js":[function(require,module,exports) {
"use strict";
...
_elements.jokeBtn.addEventListener('click', _handlers.handleClick);
